...
import gere_coworking.views.businessLayer.pagamento as b_pagamento 
import gere_coworking.views.businessLayer.config_qrcode as b_qrcode # 'b' de 'business"
...
def gerar_qrcode(request, context, id_reserva):
    ...
    #id_reserva = ReservaModel.objects.get(id_reserva=id_reserva)
    cod_do_qr = f'{chave_aleatoria}'
    ...
    img.save('static/media/qrcode.png')

        #id_reserva.id_cliente.email
    ...
    caminhoArquivo = "static/media/qrcode.png"
