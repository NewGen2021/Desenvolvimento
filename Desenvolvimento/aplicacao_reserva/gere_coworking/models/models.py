...
import datetime
import gere_coworking.models.models_helper as h     # 'h' de "Helper"
import gere_coworking.models.models_choice as c     # 'c' de "Choice"
...
class FuncionariosModel(models.Model):
    ...
    genero = models.CharField(null=True, verbose_name=_("Genero"), choices=SEXO_CHOICES, max_length=2)
