...
import apps.main.databases as db
...
DEBUG = True #QUANDO FOR SUBIR NO SVN E/OU GITHUB, DEIXE COMO "FALSE" PARA O DEPLOY FUNCIONAR E NÃO CAIR O SERVER
...
DATABASE_ROUTERS = ['main.routers.DataBaseRouter',]
