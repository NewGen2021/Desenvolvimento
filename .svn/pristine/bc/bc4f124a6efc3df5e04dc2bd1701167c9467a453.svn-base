...
def process_post_custom_view(request, context):
    ...
    print('-- INDEX INPUTS --')
    print(index_inputs)
    print('-- SERVICES INPUTS --')
    print(services_inputs)
    print('-- SLIDES INPUTS --')
    print(slides_inputs)
    return update_index_fields(index_inputs) and update_services_fields(services_inputs) and update_slides_fields(slides_inputs)
