...
cls
echo Gerando Gource
gource projetolog.xml --caption-file "timestamp.txt" --caption-size 20 --caption-duration 3 --caption-colour FFD700 --stop-at-end --key --user-image-dir "./img"  -1280x720 --title "NewGen - Log - 5 semestre" --seconds-per-day 1.2 --hide filenames --disable-progress --auto-skip-seconds 1 --date-format "%%d/%%m/%%y  %%H:%%M:%%S" -o - | ffmpeg -y -r 60 -f image2pipe -vcodec ppm -i - -vcodec libx264 -preset ultrafast -pix_fmt yuv420p -crf 1 -threads 0 -bf 0 "Final.mp4"
